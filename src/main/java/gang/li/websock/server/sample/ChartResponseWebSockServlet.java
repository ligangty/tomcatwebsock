...
import tomcat.examples.util.HTMLFilter;

/**
 *
 * @author gli
 */
@WebServlet(urlPatterns="/ChartResponse", name="wsChartResponseWebSockServlet")
public class ChartResponseWebSockServlet extends WebSocketServlet {

    private static final long serialVersionUID = 1L;
    private final Set<ChartResponseWebSockServlet.ChartOptionsMessageInbound> connections =
            new CopyOnWriteArraySet<>();

    @Override
    protected StreamInbound createWebSocketInbound(String subProtocol,
            HttpServletRequest request) {
        return new ChartResponseWebSockServlet.ChartOptionsMessageInbound();
    }
    ...
    private final class ChartOptionsMessageInbound extends MessageInbound {
        ...
        private void broadcast(String message) {
            for (ChartResponseWebSockServlet.ChartOptionsMessageInbound connection : connections) {
                try {
